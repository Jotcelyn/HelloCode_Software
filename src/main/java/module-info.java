module Modulo_Ejercicio {
    ...
    opens GestionAprendizaje_Modulo.Servicio to com.google.gson;
    opens GestionAprendizaje_Modulo.Modelo to com.google.gson;
    opens GestionAprendizaje_Modulo.Ruta to com.google.gson;

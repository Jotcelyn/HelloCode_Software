...
import java.util.*;
    ...
    public class RepositorioEnMemoria {
        ...
        private void precargarDatos() {
            ...
            // Lecciones
            Leccion leccionVars = new Leccion(UUID.randomUUID().toString(), "Variables y Tipos de Datos", "Aprende los fundamentos de las variables en Java.", "PUBLICADO", "Java", "Intermedio");
            Leccion leccionOps = new Leccion(UUID.randomUUID().toString(), "Operadores Aritméticos", "Cómo realizar sumas, restas y más.", "PUBLICADO", "Java", "Intermedio");
            Leccion leccionPoo = new Leccion(UUID.randomUUID().toString(), "Introducción a la POO", "Conceptos de Clases y Objetos.", "PUBLICADO", "Java", "Intermedio");

...
//         for (Curso c : cursos) this.cursos.put(c.getId(), c);

//         // 2. Cargar rutas asociadas
//         RutaRepository.cargarRutas(new ArrayList<>(cursos));

//         // 3. (Opcional) precargar datos de ejemplo si está vacío
